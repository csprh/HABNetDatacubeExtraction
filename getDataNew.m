...
eProj = centerXProj + round(distance1/2);
wProj = centerXProj - round(distance1/2);
nProj = centerYPro + round(distance1/2);
sProj = centerYPro - round(distance1/2);
...
%data)
eProj2 = centerXProj + round(distance1/2)*1.2;
wProj2 = centerXProj - round(distance1/2)*1.2;
nProj2 = centerYPro + round(distance1/2)*1.2;
sProj2 = centerYPro - round(distance1/2)*1.2;
