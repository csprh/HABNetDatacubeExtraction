...
for modIndex = 1:numberOfMods
    ...
    for iii = 1:length(sortIndex)
        ...
        [DummytheseImages{iii}, DummythesePoints, DummythesePointsProj] = getDataOLD(fileName,  thisLat, thisLon, round(confgData.distance1/2), confgData.resolution, ['/geophysical_data/' subMods{3}], utmstruct);
